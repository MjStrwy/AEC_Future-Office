...
public class VdmDesktopManager : MonoBehaviour {
    ...
    {
#if VDM_SteamVR
        // SteamVR_Utils.Event.Listen("device_connected", OnDeviceConnected); // out dated
    ...
    {
#if VDM_SteamVR
        //SteamVR_Utils.Event.Remove("device_connected", OnDeviceConnected); // outdated
